...
export const dashboardMenu: AdminNavigationItem = {
  id: 'dashboard',
  label: 'Dashboard',
  description: 'Ringkasan seluruh data dan konten website desa.',
  href: '/admin',
...
export const dataWargaMenu: AdminNavigationItem = {
  id: 'warga',
  label: 'Data Warga',
  description: 'Kelola database warga yang menggunakan layanan desa.',
  href: '/admin/warga',
  icon: Users,
  enabled: true,
};
...
export const permohonanMenu: AdminNavigationItem = {
  ...
  description: 'Kelola permohonan administrasi yang masuk dari warga.',
...
export const sdgsMenu: AdminNavigationItem = {
  id: 'sdgs',
  label: 'SDGs Desa',
  description: 'Kelola data dan indikator SDGs Desa Keji.',
  href: '/admin/sdgs',
  icon: Target,
  enabled: true,
};
...
export const publicContentModules: AdminNavigationItem[] = [
  ...
  },
  {
    ...
    label: 'Lapak UMKM',
    description:
      'Kelola produk UMKM, foto, harga, kontak penjual, dan status publikasi.',
    href: '/admin/umkm',
    publicHref: '/umkm',
    icon: ShoppingCart,
    enabled: false,
