...
export interface DokumenPengawasanPublik {
  id: string;
  judul: string;
  deskripsi: string;
  jenis: string;
...
export interface IndikatorPengawasanPublik {
  id: string;
  kode: string;
  judul: string;
  ringkasan: string;
  ...
  dokumen:
    DokumenPengawasanPublik[];
}

const ICON_MAP: Record<
  IndikatorPengawasanPublik['iconKey'],
  LucideIcon
> = {
  'clipboard-check':
    ClipboardCheck,
