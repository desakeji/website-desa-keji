...
export default async function PemerintahanDesaPage() {
  /*
   * Mengambil layanan aktif untuk
   * ditampilkan pada SidebarLayanan.
   */
  const {
    data: layananData,
    error: layananError,
    ...
    <div className="min-h-screen bg-slate-50 py-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mb-6 flex items-center gap-3 overflow-hidden rounded bg-emerald-800 px-4 py-2 text-sm font-medium text-white shadow-sm">
          ...
          <div className="w-full flex-1 overflow-hidden">
            <div className="animate-scrolling-pemerintahan">
              ...
              Pemerintah Desa Keji, Kecamatan Ungaran
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
          {/* Kolom kiri */}
          <article className="min-w-0 rounded-xl border border-gray-200 bg-white p-6 shadow-sm md:p-8 lg:w-2/3">
            ...
            <section>
              <div className="mb-5 border-b-2 border-emerald-100 pb-3">
                ...
                <p className="mt-1 text-sm leading-relaxed text-gray-500">
                  ...
                  sesuai bidang tugas dan wilayah
                  kerjanya.
                </p>
              </div>
            ...
            <div className="mt-8 rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm leading-relaxed text-amber-900">
              ...
              dapat ditambahkan setelah data resmi terbaru
