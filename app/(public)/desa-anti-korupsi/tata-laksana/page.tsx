  ...
  return (
    <>
      ...
      <div className="min-h-screen overflow-x-clip bg-slate-50">
        {/* Hero halaman */}
        <section className="page-hero relative isolate overflow-hidden bg-emerald-950 text-white">
          <div
            aria-hidden="true"
            ...
            <div className="mt-7 flex min-w-0 flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div className="min-w-0 max-w-4xl">
                ...
                <p className="mt-5 max-w-3xl text-sm font-medium leading-7 text-emerald-50/85 sm:text-base">
                  ...
                  Pemerintah Desa Keji yang
                  transparan, akuntabel, tertib,
                  dan berintegritas.
                </p>
              </div>

              <div className="print-hide flex shrink-0 flex-wrap items-center gap-3">
                <div className="hidden items-center gap-2 rounded-xl border border-white/15 bg-white/10 px-4 py-3 text-xs font-bold text-emerald-50 backdrop-blur sm:flex">
                  <FileSearch size={16} />
        ...
        {/* Konten */}
        <main className="print-container mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
          <TataLaksanaClient />
        </main>
      </div>
    </>
